...
public class EmailServiceImpl implements EmailService {
    ...
    public String getLoginEmailTemplate(String name, String loginTime, String loginLocation) {
        ...
        + "<h1 style=\"font-size: 1.8em; color: #3f51b5; margin: 10px 0;\">SecureBank</h1>"
        + "</div>"
        ...
        + "<p style=\"font-size: 1em; color: #555;\">Time: <strong style=\"color: #3f51b5;\">" + loginTime + "</strong></p>"
        + "<p style=\"font-size: 1em; color: #555;\">Location: <strong style=\"color: #3f51b5;\">" + loginLocation + "</strong></p>"
        ...
        + "<p style=\"font-size: 1em; color: #555;\">Regards,<br />The SecureBank Team</p>"
        + "</div>"
        + "<hr style=\"border: none; border-top: 1px solid #ddd; margin: 20px 0;\" />"
        + "<div style=\"text-align: center; font-size: 0.9em; color: #888;\">"
        + "<p>Need help? Contact our support team:</p>"
        + "<p>Email: <a href=\"mailto:support@securebank.com\" style=\"color: #3f51b5; text-decoration: none;\">support@securebank.com</a></p>"
        + "</div>"
        + "</div>"
        + "</div>";
    ...
    public String getOtpLoginEmailTemplate(String name, String accountNumber, String otp) {
        ...
        + "<div style=\"margin: 50px auto; width: 100%; max-width: 600px; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1);\">"
        + "<div style=\"border-bottom: 1px solid #ddd; padding-bottom: 10px; text-align: center;\">"
        + "<a href=\"https://securebank.app/\" style=\"text-decoration: none;\">"
        + "<img src=\"https://securebank.app/assets/logo.png\" alt=\"SecureBank\" style=\"height: 50px; margin-bottom: 10px;\">"
        + "</a>"
        + "<h1 style=\"font-size: 1.8em; color: #3f51b5; margin: 10px 0;\">SecureBank</h1>"
        + "</div>"
        + "<div style=\"padding: 20px;\">"
        ...
        + "<p style=\"font-size: 1em; color: #333;\">Thank you for choosing SecureBank. Use the following OTP to complete your login procedures. The OTP is valid for "
